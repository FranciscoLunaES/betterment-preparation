...
# Encapsulation - concept of blocking off areas of code and not 
# making it available to the rest of the program

# Abstraction - is simplifying a complex process of a program, an enterprise software solution for 
# example by modeling classes appropriate for it
